...
<section class="content d-flex flex-row" style="min-height: 1200px; overflow-y: auto;">
    ...
    <div style="width: 280px; border-right: #f2f2f2 solid 1px;">
        <div class="d-flex align-items-center ps-4" style="height: 55px; border-bottom: #f2f2f2 solid 1px;">
            ...
            <p class="mt-3 ms-2 me-5">{{$selectedWorkspace->name}}</p>
            <a href="" class="btn p-0 ms-4">
    ...
    <div class="" style="width: 100%;">
        ...
        <ul class="nav nav-tabs flex-row" style="height: 55px;">
            ...
            <li class="nav-items">
                <a class="nav-link fst-italic" data-bs-toggle="tab"  href="#file_{{$collection->id}}">{{$collection->name}}
        ...
        <div class="tab-content">
            @foreach($collections->reverse() as $index => $collection)
            <div class="tab-pane" id="file_{{$collection->id}}">
