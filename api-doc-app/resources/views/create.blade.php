...
<div class="row m-0" style="height: 100%">
    <form class="col-4 ps-4 pt-4" action="{{route('workspace.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <label class="btn btn-outline d-flex p-0" for="personal" style="width:100%; height:55px;">
            <div class="col-2">
        ...
        <label class="btn btn-outline d-flex p-0" for="team" style="width:100%; height:55px;">
            <div class="col-2">
